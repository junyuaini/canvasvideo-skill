...
**坐标公式**（viewport 780×585，区域间隙 120px）：
...
**规划方法**：`row = Math.floor((index - 1) / 4)`、`col = (index - 1) % 4`

**canvas 推荐尺寸**（覆盖区域所需的最小画布）：

| 区域数 | 行数 | 推荐 canvas |
|---|---|---|
| 1-4 | 1 行 | `width: 3300, height: 700` |
| 5-8 | 2 行 | `width: 3300, height: 1300` |
| 9-12 | 3 行 | `width: 3300, height: 1900` |
| 13-16 | 4 行 | `width: 3300, height: 2500` |
...
"regions": [
  ...
  { "name": "P5", "x": 120,  "y": 650 },
  { "name": "P6", "x": 900,  "y": 650 },
  { "name": "P7", "x": 1680, "y": 650 },
  { "name": "P8", "x": 2460, "y": 650 },
  { "name": "P9", "x": 120,  "y": 1250 },
  { "name": "P10","x": 900,  "y": 1250 }
],
"canvas": { "width": 3300, "height": 1900 }
```
